...
- Minifying: Fit things onto one line


### De-obfuscation Techniques
- Beautifying: Puts into correct format (Firefox built in with {} button)

Base64 can be spotted with = padding. 

Rot13 shifts character one over... a -> b   b -> c ...etc
